  ...
  <p>
    ...
    Mượn sách, đặt chỗ và quản lý thông tin một cách dễ dàng.
      ...
      <div class="hero-buttons">
        <a href="{{ url('search-book-user.html') }}" class="btn primary-btn">
        ...
        <a href="{{ url('signup-user.html') }}" class="btn secondary-btn">
...
<section class="features-section">
  ...
  <div class="features-grid">
    <a href="{{ url('user/search-book-user') }}" class="feature-link">
    ...
    <a href="{{ url('user/trangmuontra(sachdangmuon)') }}" class="feature-link">
      <div class="feature-box">
        <div class="feature-icon">
    ...
    <a href="{{ url('user/datchosach') }}" class="feature-link">
      <div class="feature-box">
        <div class="feature-icon">
    ...
    <a href="{{ url('user/tranglichsumuontra') }}" class="feature-link">
      <div class="feature-box">
        <div class="feature-icon">
...
<section class="favorite-books">
  <div class="section-header">
    ...
    <a href="{{ url('user/search-book-user') }}" class="view-all">Xem tất cả →</a>
  </div>
...
<section class="cta-section">
  ...
  <div class="cta-buttons">
    ...
    <a href="{{ url('user/search-book-user') }}" class="btn btn-secondary">
...
@include('user.layouts.footer-homepage-user')
